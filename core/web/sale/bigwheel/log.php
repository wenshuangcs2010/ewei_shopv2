...
//      unset($row);
        ...
        $total = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_user_lottery') . " where lottery_id=:lottery_id ", array(":lottery_id"=>intval($_GPC['id'])));
        load()->func('tpl');
        include $this->template("sale/bigwheel/log");
    }
