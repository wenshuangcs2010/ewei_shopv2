    ...
    class GlobonusModel extends PluginModel
    {
        ...
        function getBonus($openid = '',$params = array())
        {
            ...
            if(in_array('lock',$params)) {
                $ret['lock']= pdo_fetchcolumn('select ifnull(sum(paymoney),0) from ' . tablename('ewei_shop_globonus_billp') . ' where openid=:openid and status<>1 and uniacid=:uniacid limit 1',
                    array(':uniacid' => $_W['uniacid'], ':openid' => $openid));
            }
