define(['jquery.ui'], function (ui) {
    ...
    modal.initNavs = function () {
        modal.getNavs();
        var navgroup = {
            0: ['listmenu', 'richtext', 'title', 'line', 'blank', 'menu', 'menu2', 'picture', 'banner', 'picturew', 'pictures', 'icongroup', 'audio','navigation'],
            1: ['search', 'notice', 'goods', 'merchgroup', 'diymod'],
            2: ['search', 'notice', 'goods', 'merchgroup','seckillgroup', 'diymod'],
            3: ['member', 'bindmobile', 'logout'],
            4: ['memberc', 'blockgroup'],
            5: ['detail_tab', 'detail_swipe', 'detail_info', 'detail_sale', 'detail_spec', 'detail_package', 'detail_shop', 'detail_store', 'detail_buyshow', 'detail_comment', 'detail_pullup', 'detail_navbar', 'goods','detail_seckill'],
            6: ['goods', 'search', 'merchgroup'],

            7: ['seckill_times', 'seckill_rooms', 'seckill_advs', 'seckill_list'],
           // 8: ['seckill_times', 'seckill_rooms', 'seckill_advs', 'seckill_list'],
        ...
        modal.navs = {
            ...
            navigation: {
               name: '顶部导航',
                ...
                data: {
                    C0123456789101: {text: '文字1', linkurl: '', imgurl: "", iconclass: 'icon-home', remark: '查看', dotnum: ''},
                    C0123456789102: {text: '文字2', linkurl: '', imgurl: "", iconclass: 'icon-home', remark: '查看', dotnum: ''},
                    C0123456789103: {text: '文字3', linkurl: '', imgurl: "", iconclass: 'icon-home', remark: '查看', dotnum: ''}
                }
            },
            listmenu: {
                name: '列表导航',
