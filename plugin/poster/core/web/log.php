...
class Log_EweiShopV2Page extends PluginWebPage {
	...
	function main() {
		...
		$list = pdo_fetchall("SELECT log.*, m.avatar,m.nickname,m.realname,m.mobile,m1.avatar as avatar1,m1.nickname as nickname1,m1.realname as realname1,m1.mobile as mobile1 FROM " . tablename('ewei_shop_poster_log') . " log "
