...
class Detail_EweiShopV2Page extends PluginMobileLoginPage {
	...
	function main(){
        ...
        $advs[] = array(
            'thumb' => 'http://demo.foxteam.cc/attachment/images/11/2016/07/nDWWvjzIPJHfdX1p1AbBccF1Z2VIPd.png',
...
/*
        if(is_h5app()){
            ...
            $payinfo = array(
                'wechat' => !empty($wapset['mcname']) && !empty($wapset['payment']['wechat']) && !empty($wapset['mcappid']) && !empty($wapset['mcappsecret']) && !empty($wapset['mcid']) && !empty($wapset['mcapikey']) && !empty($order['price']) ? true : false,
                'alipay' => false,
                'mcname' => $wapset['mcname'],
                'logno' => null,
                'money' => null,
                'attach' => $_W['uniacid'] . ":2",
                'type' => 2
